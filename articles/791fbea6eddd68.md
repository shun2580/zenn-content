...
あわせて Ollama 側も見直しました。初期は `qwen2.5:7b` を2体動かしていましたが、RTX 4060 Ti 8GB では複数体の同時推論が現実的ではありません。そこで**1体に集約したうえで、より性能の高い `qwen3.5:9b` に切り替える**判断をしました。台数を絞る代わりにモデルの賢さを取った形です。
